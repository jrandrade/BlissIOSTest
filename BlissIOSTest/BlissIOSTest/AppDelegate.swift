...
//  BlissIOSTest
//
//  Created by Jorge Andrade on 13/12/2018.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setupGlobalAppAppearance() {
        ...
        //UINavigationBar.appearance().backgroundColor = StyleKit.green
        UINavigationBar.appearance().barTintColor = StyleKit.mainColor
